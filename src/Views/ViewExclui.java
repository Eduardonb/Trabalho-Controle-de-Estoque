...
public class ViewExclui extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewExclui frame = new ViewExclui();
	...
	public ViewExclui() {
		...
		btnVoltar.setBounds(345, 289, 77, 25);
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewExclui.this.dispose();
		...
		btnConfirma.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
						JOptionPane.showMessageDialog(null, "Primeiro Selecione o produto!");
				}else{
					if(JOptionPane.showConfirmDialog(null, "Confirma exclusão?") == 0){
						textNome.getText();
						gerenciador.excluiProdutoo(textNome.getText());
		...
		btnConfirma.setBounds(168, 256, 117, 25);
